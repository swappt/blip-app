...
icon.filename = org_assets/icon_free.png
package.name = blipapp
version = 1.0.0.9
...
source.include_exts = py,png,kv,gif,ogg,ttf,meta,zip

# (list) List of directory to exclude (let empty to not exclude anything)
source.exclude_dirs = bin,examples,.git,org_assets,utils
